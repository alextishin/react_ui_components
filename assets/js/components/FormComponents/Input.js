...
var Input = React.createClass({
  ...
  render: function(){
    ...
    var inputGroupClasses = 'input_group';
    ...
    // });
    if(this.state.valid) {
      inputGroupClasses += ' input_valid'
    } else {
      inputGroupClasses += ' input_error'
    }

    if(this.state.empty) {
      inputGroupClasses += ' input_empty'
    } else {
      inputGroupClasses += ' input_hasValue'
    }

    if(this.state.focus) {
      inputGroupClasses += ' input_focused'
    } else {
      inputGroupClasses += ' input_unfocused'
    }
